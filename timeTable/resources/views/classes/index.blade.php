    ...
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="sm:text-4xl text-3xl font-medium title-font mb-2 text-gray-900">
        <font style="vertical-align: inherit;">
          <font style="vertical-align: inherit;">教室登録一覧</font>
        </font>
      </h1>
    </div>
  </div>
                ...
                <thead>
                  <tr>
                    <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl">
                      <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">教室名</font>
                      </font>
                      <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">フロア</font>
                      </font>
                      <font style="vertical-align: inherit;">
                        <font style="vertical-align: inherit;">収納人数</font>
                      </font>
                    </th>
                ...
                <tbody>
                  ...
                  <tr>
                    <td class="px-4 py-3 divide-y divide-light-blue-700 border-4 border-gray-500/100">
                      <font style="vertical-align: inherit;">
                        <font class="text-2xl" style=" vertical-align: inherit;">教室名：{{$classe ->classroom_name}}</font><br>
                        <font class="text-2xl" style=" vertical-align: inherit;">フロア：{{$classe ->floor}}</font><br>
                        <font class="text-2xl" style=" vertical-align: inherit;">収納人数：{{$classe ->capacity}}</font><br>
                        ...
                        <font class="text-2xl flex " style=" vertical-align: inherit;">科目分類：{{$department ->department_classification}} --}}
                          <div class="flex justify-end">
                            ...
                            <form id="delete_{{ $classe->id }}" method="post" action="{{route('classes.destroy',$classe->id)}}">
                              @csrf
                              @method('delete')
                              <button class="ml-auto mr-4 mt-4  text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded " href="#" data-id="{{ $classe->id }}" onclick="deletePost(this)">削除</button>
                          </div>
                            </form>
                        </font><br>
                      </font>
