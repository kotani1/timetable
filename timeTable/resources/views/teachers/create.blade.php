...
<body>
    <p>ユーザー名</p>
    <div class="inner">
    <input type="text" maxlength="100" placeholder="ユーザー名" id="user_name" class="inner">
    </div>
    <p>ログインID</p>
    <div class="inner">
    <input type="text" maxlength="200" id="login_id">
    </div>
    <p>パスワード</p>
    <div class="inner">
    <input type="password" maxlength="20" placeholder="半角英数8文字以上" id="password" class="inner">
    </div>
    <p>権限</p>
    <div class="inner">
    <select name="permit">
