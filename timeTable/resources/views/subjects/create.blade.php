...
<body>
    ...
    <div class="inner">
    <select name="period">
        <option value="0" class="inner">前期</option>
        <option value="1" class="inner">後期</option>
    </select>
    </div>
    ...
    <p>科目分類</p>
    <div class="inner">
        <input type="text" maxlength="100" placeholder="科目分類" id="subject classification" name="subject classification" class="inner">
    </div>

    <p>科目内容</p>
    <div class="inner">
        <textarea id="subject content" name="subject content" cols="50" rows="10" maxlength="20"></textarea>
    </div>
